...
public class Action extends BaseClass {
	...
	public static boolean selectByIndex(WebElement element,int index)
	{
		...
		finally
		{
			...
			{
				System.out.println("options not selected by Index");
			}
		}
	...
	public static boolean selectByValue(WebElement element,String value)
	{
		...
		finally
		{
			if(flag)
			{
				System.out.println("options selected by Value");
			}
			else
			{
				System.out.println("options no selected by Value");
			}
		}
	...
	public static boolean selectByVisibleText(String visibletext,WebElement ele)
	{
		...
		finally
		{
			if(flag)
			{
				System.out.println("Options selected by Visible Text");
			}
			else
			{
	...
	public String generateRandomFirstName() {
        // Generate a random first name (you can customize the length and character set)
        return RandomStringUtils.randomAlphabetic(8);
    }

	public String generateRandomLastName() {
        // Generate a random last name (you can customize the length and character set)
        return RandomStringUtils.randomAlphabetic(8);
    }

	public String generateRandomEmail() {
        // Generate a random email address
        String uniqueString = RandomStringUtils.randomAlphanumeric(5);
        return "user" + uniqueString + "@example.com";
    }

	public String generateRandomPassword() {
        // Generate a random password (you can customize the length and character set)
