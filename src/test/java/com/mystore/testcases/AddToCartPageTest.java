...
public class AddToCartPageTest extends BaseClass {
	...
	@Test(groups="Smoke")
	public void addProductToCartProceedToShippingAdressPagewWithLogin() throws InterruptedException
	{
	...
	@Test(groups="Smoke")
	public void addProductToCartProceedToShippingAdressPagewWithOutLogin() throws InterruptedException
	{
		indexPage = new IndexPage();
		signInPage = new SignInPage();
		homePage = new HomePage();
